...
const serviceItems = [
  ...
  },
  {
    ...
    description: "Soluzioni su misura per ripristinare denti mancanti.",
    link: "/trattamenti/protesi-dentali"
  },
    {
    ...
    title: "Endodonzia",
    description: "Trattamento dei canali radicolari per salvare denti compromessi.",
    link: "/trattamenti/endodonzia"
  }
];
